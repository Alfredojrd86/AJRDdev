...
import proj1 from "../../public/images/projects/fc-group.png";
import loading from "../../public/images/articles/Code.png";
      ...
      >
        <Layout className="pt-16">
          <AnimatedText
            ...
            text="La imaginación transforma el mundo ✨"
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeaturedProject
                ...
                tools="HTML | CSS | JavaScript | Nextjs | Tailwind"
                title="Fc Group"
                summary="Sitio web de la empresa Fc Group"
                img={proj1}
                date="2023"
          ...
          <div>
            <ul className="flex flex-col items-center relative pt-16">
              <Article
                ...
                title="Proximamente más, gracias por el interés!"
                img={loading}
                time="1 min read"
                date=""
