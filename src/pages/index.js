...
import profilePic from "../../public/images/profile/AJRDAVATAR.png";
            ...
            <div className="flex w-1/2 flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <div className="flex w-1/2 w-full items-center items-start lg:w-full  lg:!justify-center  sm:!justify-center  md:!text-center md:inline-block md:w-full">
                <h2 className="animate-text bg-gradient-to-r from-lightGreen via-lightGreen to-slideGreen bg-clip-text text-transparent font-semibold capitalize !text-5xl xl:!text-4xl lg:!text-4xl md:!text-5xl sm:!text-3xl">
                  ...
                  Creo experiencias web que conectan.
                </h2>
              </div>

              <p className="my-4 text-base font-medium md:text-sm sm:!text-sm">
                {/* I'm a front-end web developer, passionate
                ...
                Soy desarrollador web, apasionado por crear sitios y aplicaciones que no solo sean atractivos, sino también fáciles de usar.
                Me especializo en todo lo que los usuarios ven y con lo que interactúan (diseño y experiencia),
                así como en lo que sucede detrás de escena para asegurar que todo funcione correctamente.
                Mi objetivo es combinar un diseño visual impactante con una funcionalidad impecable en cada proyecto.
              </p>
